...
SUBMIT_DIR = BASE_DIR / 'work/submit_v8'
MODEL_DIR = SUBMIT_DIR / 'model'
DUMMY_DIR = BASE_DIR / 'work/dummy_eval_v8'
V7_MODEL_DIR = BASE_DIR / 'work/submit_v7/model'
...
print("=" * 70)
print("[Task 1] Reusing v7's GBDT models (identical 5-seed config, verified in 157번)")
print("=" * 70)
gbdt_files = list(V7_MODEL_DIR.glob('*'))
for f in gbdt_files:
    shutil.copy(f, MODEL_DIR / f.name)
    print(f"  Copied from v7: {f.name}")
...
# =========================================================================
# WORK: Package submit_v8.zip
# =========================================================================
print("\n" + "=" * 70)
print("[Task 6] Packaging submit_v8.zip")
print("=" * 70)
...
with open('/tmp/submit_v8_build_result.json', 'w') as f:
    json.dump({
