...
print("Loading train.csv and building 136 features for submit_v41 MLP...")
...
print("Saved updated 136-feature mlp_artifacts.pkl")
...
for s_idx, seed in enumerate(SEEDS):
    t_s = time.time()
    print(f"Training SimpleMLP_MSE Seed {seed} ({s_idx+1}/5) on 136 features...")
    ...
    print(f"  Saved {model_save_path} in {time.time() - t_s:.1f}s")

print("All 5-seed SimpleMLP models on 136 features successfully trained and saved!")
